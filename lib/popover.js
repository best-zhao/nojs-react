...
var Popover = React.createClass({
    ...
    componentDidMount () {
        ...
        var self = this
        var {nearby}  = this.state
        var {relative, offset, position, delegate, trigger} = this.props
        ...
        if( trigger=='hover' ){
            ...
            if( nearby ){
                _event = 'mouseover'+eventSP
                events += _event
                nearby.on(_event, _show)

                _event = 'mouseout'+eventSP
                events += ' '+_event
                ...
                $(delegate[1]||document.body).delegate(delegate[0], 'mouseover', _show)
                .delegate(delegate[0], 'mouseout', hide)
            }
