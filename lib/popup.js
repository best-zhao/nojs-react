...
var Statics = {
  ...
  alert (options) {
      options = Object.assign({
          ...
          bindEsc : false,
          buttons : [
              {text:'确定', className:'nj-button nj-button-red'}
          ]
      }, options);
  ...
  confirm (options) {     
      options = Object.assign({
          ...
          buttons : [
              {text:'确定', className:'nj-button nj-button-red', handle:function(){
                  return true
              }},
        ...
        var tip = Popup.tip.handle = Popup.alert({
            ...
            template : (
                <div className={"tip-area tip-"+type}><i className={"nj-icon nj-icon-"+type}></i>
                    <span className="tip-text">{message}</span>
                </div>
            ),
            showMask : false,
            buttons : null
  ...
  render () {
    ...
    return (
        <div className={className}>
          <div className="_close" onClick={this.setDisplay.bind(this,false)}></div>
          <div className="_head">{this.state.title}</div>
          <div className="_body" ref="body">{template}</div>
