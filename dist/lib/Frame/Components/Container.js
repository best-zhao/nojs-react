...
var Container = function (_React$Component) {
    ...
    function Container(props) {
        ...
        _this.state = {
            ...
            topbarItems: [{ content: _.React.createElement('i', { className: 'nj-icon nj-icon-menu' }), type: 'button', handle: _this.toggleMenu, align: 'left' }, { content: _.React.createElement('i', { className: 'nj-icon nj-icon-back' }), type: 'button', handle: function handle(e) {
